...
class PackageNames:
    ...
    def replace_in_file(self, filename: str):
        valid_extensions = ["py", "cpp", "h", "pyi", "txt", "toml", "ini", "yaml", "md"]
        ok = False
...
def main():
    ...
    if interactive:
        ...
        package_names.cpp_library_name = "imgui"
        package_names.python_package_name = "lg_imgui"
        package_names.pip_package_name = "lg-imgui"
